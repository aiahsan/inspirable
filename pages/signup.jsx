    ...
    const postCat = async (datapost) => {
        ...
        const { data, status } = await repository.register(datapost).then(x => x).then(x => x)
            if(status==200)
            {
                ...
                await repository.contacts(data).then(x=>x).then(x=>x)      
                setshowanimation(false)

                history.push({pathname:"thankyou/", query: { data: JSON.stringify({user:data.me,token:data.access_token}) }})  
            }
            else
    ...
    />
        ...
        <div className="">
            ...
            <div className="col-md-6 col-12 ">
                ...
                <p className="adsfmi3o2049-4okjda-sad mt-n2"> Let's create your account!</p>
...
<div className="row ">
                        <div className="col-md-6 p-0 m-0">
                            <label className="asdfn023u21-osld34-fas38">First Name</label>
                            <input {...getFieldProps("first_name")} className="form-control asdmi394iejm423i8ds7ayh1-as"/>
                            {touched.first_name && errors.first_name && <div style={{ color: 'red', marginTop: 10,maxWidth:320 }}>{errors.first_name}</div>}
                        </div>
                        <div className="col-md-6 ">
                            <label className="asdfn023u21-osld34-fas38">Last Name</label>
                            <input {...getFieldProps("last_name")} className="form-control asdmi394iejm423i8ds7ayh1-as"/>
                            {touched.last_name && errors.last_name && <div style={{ color: 'red', marginTop: 10,maxWidth:320 }}>{errors.last_name}</div>}
                    ...
                    <div className="row">
                        <div className="col-md-12 p-0 m-0">
                            ...
                            <input {...getFieldProps("email")} style={{width:'97%'}} className="form-control asdmi394iejm423i8ds7ayh1-as"/>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 ">
                            ...
                            <FiEyeOff onClick={()=>setshowpassword1(!showpassword1)} className="asdnas8fs9a0023-asfh3" style={{    right: 30}}/>
                    ...
                    <button  onClick={handleSubmit} type="button" className="btn sgn-btn sgn-btn-wht w-100 mt-4" >
                            Sign Up
                            </button> 
                            <p className="dasf93uj497c6s03-214a9d34 mt-3">
                            By clicking Sign Up, you are indicating that you have read and agree to our <a href="/terms">Terms of Use</a> and <a href="/privacy"> Privacy Policy</a>
                            </p>
