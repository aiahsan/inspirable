  ...
  {showanimation ? <Loading />
        ...
        <div className="">
            ...
            <div className="col-md-6 col-12 ">
                ...
                <Formik
                    initialValues={{
                        email:parsed[Object.keys(parsed)[0]]?parsed[Object.keys(parsed)[0]]:"",
                        password: '',
                ...
                <div className="mt-5">
                    ...
                    <div className="col-md-12 ">
                            ...
                            <FiEyeOff onClick={()=>setshowpassword(!showpassword)} className="asdnas8fs9a0023-asfh3" style={{    right: 30}}/>
                        </div>
                        
                    </div>
                 
                 
                 <button onClick={handleSubmit} className="btn sgn-btn sgn-btn-wht w-100 mt-4" >
                            Sign In
                            </button> 
                            <button onClick={()=>history.back()} className="btn sgn-btn safas02i-2-43asfsf3 w-100 mt-2"  >
                           Back
                            </button>   
                </div>
