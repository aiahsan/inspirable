      ...
      {showmessage ? <Toast style={{
        ...
        <div className="mt-5 mb-5 ask-question-bx container">
            ...
            <Formik
               ...
               <input  {...getFieldProps("name")} className="form-control ask-inpt mt-4 pl-4" placeholder="First Name" />
               {touched.name && errors.name && <div style={{ color: 'red', marginTop: 10,maxWidth:320 }}>{errors.name}</div>}
               <input  {...getFieldProps("subject")} className="form-control ask-inpt mt-4 pl-4" placeholder="Subject" />
               {touched.subject && errors.subject && <div style={{ color: 'red', marginTop: 10,maxWidth:320 }}>{errors.subject}</div>}

            <input  {...getFieldProps("email")}  className="form-control ask-inpt mt-4 pl-4" placeholder="Email address" />
            {touched.email && errors.email && <div style={{ color: 'red', marginTop: 10,maxWidth:320 }}>{errors.email}</div>}

            <textarea  {...getFieldProps("message")}  class="form-control text-secondary mt-4 br-2" id="exampleFormControlTextarea1" rows="6" placeholder="Message"></textarea>
